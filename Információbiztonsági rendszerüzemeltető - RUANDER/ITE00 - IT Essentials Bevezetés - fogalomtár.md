...
**Információtechnológia (IT)** – Digitális információ kezelése hardver, szoftver és hálózatok segítségével.

**Iparági minősítés (certification)** – Vizsgával megszerezhető hivatalos igazolás arról, hogy egy adott területen (pl. támogatás, hálózat, biztonság) megfelelő szintű tudásunk van.

**CompTIA A+** – Nemzetközileg elismert, belépő szintű minősítés PC-k, mobil eszközök, operációs rendszerek, hálózatok és IT-biztonság alapjaira.

**EUCIP IT Administrator** – Európai szabványokra épülő minősítés, modulokra bontva fedi le a hardver, operációs rendszer, hálózat és IT-biztonság területét.

**Cisco CCNA** – Hálózati alapismereteket igazoló, világszerte elismert Cisco-minősítés, amely ma már egyetlen, 200-301 kódú vizsgából áll.

**Role-based Microsoft minősítések** – A régi MCSA/MCSE helyét átvett, konkrét munkakörökre (pl. Azure adminisztrátor, biztonsági mérnök) épülő modern Microsoft vizsgák.

**Field / remote / bench technikus** – Különböző IT-támogató szerepkörök: helyszíni kiszállás, távoli segítségnyújtás vagy műhelyben végzett javítás.

**CEU (Continuing Education Unit)** – Továbbképzési egység; pontok, amelyeket bizonyos tanúsítványok megújításához kell összegyűjteni (pl. A+ esetén 3 évente 20 CEU).
