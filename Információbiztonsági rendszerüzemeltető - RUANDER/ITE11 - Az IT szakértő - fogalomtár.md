...
**Kommunikációs készség** – Az IT-támogatás egyik alapkompetenciája, amely lehetővé teszi a hibák pontos feltárását, a világos tájékoztatást és a hatékony együttműködést felhasználókkal, kollégákkal és partnerekkel.

**Aktív hallgatás** – Olyan tudatos kommunikációs technika, amelyben a szakember figyelmesen végighallgatja a másik felet, pontosít, visszajelez és ellenőrzi, hogy helyesen értette-e a problémát.

**Professzionális magatartás** – Szakmailag és emberileg is megfelelő, nyugodt, tiszteletteljes és következetes viselkedés, amely támogatja a bizalomépítést és a minőségi ügyfélkezelést.

**Zárt kérdés** – Olyan kérdésforma, amely rövid, egyértelmű választ vár, ezért különösen hasznos hibabehatárolásnál, állapotellenőrzésnél és döntési pontok tisztázásánál.

**Ügyfélvárakoztatás** – Az ügyfél ideiglenes várakozó állapotba helyezése ellenőrzés, egyeztetés vagy háttérmunka céljából, mindig rövid tájékoztatással és kulturált kommunikációval kísérve.

**Hívásátirányítás** – Egy ügy vagy kapcsolat továbbítása olyan munkatárshoz vagy szakterülethez, amely jogosultság, szaktudás vagy felelősségi kör alapján hatékonyabban tudja kezelni a problémát.

**Nehéz ügyféltípusok** – Olyan kommunikációs helyzetek vagy ügyfélviselkedések összefoglaló neve, amelyek fokozott empátiát, türelmet, határozottságot és konfliktuskezelési készséget igényelnek.

**Netikett** – A digitális kommunikáció udvariassági, viselkedési és szakmai szabályainak összessége, amely az e-mailes, chates, jegykezelő és online együttműködési környezetekben is érvényes.

**Ergonómia** – A munkakörnyezet, az eszközhasználat és a munkavégzési szokások olyan kialakítása, amely csökkenti a fizikai terhelést, támogatja az egészséget és növeli a hatékonyságot.

**Időgazdálkodás** – A feladatok, incidensek és prioritások tudatos kezelése annak érdekében, hogy a rendelkezésre álló időben a legfontosabb tevékenységek készüljenek el megfelelő minőségben.

**Stresszkezelés** – Olyan módszerek és önszabályozási technikák alkalmazása, amelyek segítenek a mentális terhelés csökkentésében, a koncentráció fenntartásában és a kiegyensúlyozott munkavégzésben.

**SLA (Service Level Agreement)** – Szolgáltatási szintmegállapodás, amely rögzíti a támogatási szolgáltatás mérhető elvárásait, például a reakcióidőt, a helyreállítási időt és a rendelkezésre állást.

**Üzletpolitika** – A szervezet működését meghatározó belső szabályok, eljárások és irányelvek rendszere, amelyek kiterjedhetnek a támogatási folyamatokra, biztonságra, jogosultságokra és kommunikációra is.

**Ügyfél-elégedettség** – Az ügyfél tapasztalatának és benyomásának összessége arról, hogy a kapott támogatás mennyire volt gyors, érthető, eredményes és professzionális.

**Etikai szabályok** – Azok az alapelvek, amelyek előírják a tisztességes, felelős és bizalmas munkavégzést, különös tekintettel az adatokra, a hozzáférésekre és a felhasználói bizalomra.

**Jogi megfelelés** – Az informatikai tevékenység során alkalmazandó jogszabályok, szabványok és szervezeti kötelezettségek betartása, különösen adatvédelem, szerzői jog, naplózás és hozzáférés-kezelés területén.

**Számítógépes kriminalisztika** – A digitális bizonyítékok szakszerű azonosításával, rögzítésével, megőrzésével, elemzésével és értelmezésével foglalkozó szakterület.

**Megmaradó adatok** – Olyan adatok, amelyek a rendszer kikapcsolása vagy újraindítása után is elérhetők maradnak, tipikusan háttértáron, naplókban vagy tartós tárolókon.

**Átmeneti adatok** – Olyan adatok, amelyek csak ideiglenesen állnak rendelkezésre működés közben, és kikapcsolás, újraindítás vagy kapcsolatmegszakadás után elveszhetnek.

**Elsődleges beavatkozó** – Az a személy, aki egy incidens vagy gyanús esemény helyszínén elsőként jár el, és akinek kiemelt szerepe van a helyzet biztosításában, az adatok megőrzésében és a megfelelő eljárás elindításában.

**Dokumentáció** – A munkafolyamatok, hibajegyek, beavatkozások, konfigurációk, megfigyelések és döntések rendszerezett, pontos és visszakövethető rögzítése.

**Felügyeleti lánc** – A bizonyítékok kezelésének dokumentált folyamata, amely igazolja, hogy az adat vagy eszköz mikor, kinél, milyen körülmények között volt, és nem sérült a hitelessége.

**Ügyfélszolgálat / help desk** – Olyan támogatási funkció, amely a felhasználói hibabejelentések fogadására, nyilvántartására, elsődleges kezelésére és szükség esetén továbbítására szolgál; modern környezetben gyakran service desk formában működik.

**Első szintű technikus** – Az első vonalbeli támogatást végző szakember, aki azonosítja a problémát, alapvető hibakeresést végez, dokumentál és a gyakori esetek jelentős részét önállóan megoldja.

**Második szintű technikus** – Magasabb technikai szintű támogatást nyújtó szakember, aki az összetettebb, speciális szaktudást vagy mélyebb rendszerismeretet igénylő eseteket kezeli.
