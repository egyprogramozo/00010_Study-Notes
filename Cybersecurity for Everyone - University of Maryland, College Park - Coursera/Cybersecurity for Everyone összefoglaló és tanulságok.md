...
A **másodlagos hatások** már az üzleti működés szintjén jelentkeznek: bevételkiesés, leállt gyártósorok, túlórák, eszközcserék költsége, jogi eljárások, bírságok, reputációs károk. Ha „csak” egy weboldal felülete van megrongálva (defacement), amit fél óra alatt vissza lehet állítani, a másodlagos hatás kicsi. Ha viszont három napra leáll egy teljes üzem vagy egy légitársaság jegykiadó rendszere, akkor a közvetett következmények már sokszorosan meghaladják az eredeti technikai kárt.
